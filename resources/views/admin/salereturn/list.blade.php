...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('sale-returns')}}"><i class="fa fa-undo"></i> Sale returns</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-purple box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sale returns list</h3>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<form action="{{route('sale-returns-destroy',$return->id)}}" method="post" style="display: none;" id="delete-form-{{$return->id}}">
                                            @csrf
                                            {{method_field('DELETE')}}
                                        </form>
