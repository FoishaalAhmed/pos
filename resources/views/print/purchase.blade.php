        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin: 1px;" >
                        <p style="font-size:25px; font-weight: 900; text-align: center; margin: 0px; " >  Purchase Invoice  </p>
                        <hr style="margin: 1px;" >
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="left-side">
                                    <p style="margin-bottom: 1px;">Name : {{$supplier->name}}</p>
                                    <p style="margin-bottom: 1px;">Mobile : {{$supplier->phone}}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="right-side" style="margin-top: 20px;" >
                                    ...
                                    <p style="margin-bottom: 1px;">Invoice No : {{$purchase->invoice}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6" style="text-align: right;">
                                            <p style="margin: 0px;" >{{$purchase->subtotal}} ৳</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-4">
                                            <p style="margin: 0px;" >Vat ({{$purchase->vat_percentage}}%) </p>
                                            <p style="margin: 0px;" >Discount ({{$purchase->discount_percentage}}%)</p>
                                        </div>
                                        <div class="col-2">
                                            <p style="margin: 0px;" >=</p>
                                            <p style="margin: 0px;" >=</p>
                                        ...
                                        <div class="col-6" style="text-align: right;">
                                            <p style="margin: 0px;" >{{$purchase->vat}} ৳</p>
                                            <p style="margin: 0px;" >{{$purchase->discount}} ৳</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6" style="text-align: right;">
                                            <p style="margin: 0px;" >{{$purchase->total}} ৳</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6" style="text-align: right;">
                                            <p style="margin: 0px;" >{{$purchase_payment->total_paid}} ৳</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6" style="text-align: right;">
                                            <p style="margin: 0px;" >{{$purchase->total - $purchase_payment->total_paid}} ৳</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
